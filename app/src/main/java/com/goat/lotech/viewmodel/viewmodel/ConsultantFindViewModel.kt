...
class ConsultantFindViewModel: ViewModel() {
    private val consultantList = MutableLiveData<ArrayList<ConsultantVerifyModel>>()
    private val TAG = ConsultantFindViewModel::class.java.simpleName
            ...
            Firebase.firestore.collection("consultant")
                ...
                .addOnSuccessListener { documents ->
                    for (document in documents) {
                        ...
                        userItem.like = Integer.parseInt(document.data["like"].toString())
                        userItem.price = document.data["price"].toString()
